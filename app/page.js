            ...
            <div className="flex flex-col w-[90%] text-black  ">
              ...
              <form method="post" className="flex flex-col gap-2 w-full ">
                <div className="flex flex-col gap-0.5">
                  ...
                  <input className="w-full h-8 pl-3  border-black border-[1px] rounded-xl" type="text" placeholder="Enter first name" />
                </div>
                <div className="flex flex-col gap-0.5">
                  <label className=" text-sm">Last Name</label>
                  <input className="w-full h-8 pl-3 border-black border-[1px] rounded-xl" type="text" placeholder="Enter Last name" />
                </div>
                <div className="flex flex-col gap-0.5">
                  <label className="text-sm">Email Address</label>
                  <input className="w-full h-8 pl-3  border-black border-[1px] rounded-xl" type="email" placeholder="Email Address" />
                </div>
                <div className="flex flex-col gap-0.5">
                  <label className=" text-sm">Phone Number</label>
                  <div className="relative w-full h-8 pl-3 border-[1px]  border-black rounded-xl flex items-center">
                    ...
                    <input className="h-8 w-4/5 rounded-r-xl no-spinner pl-3 tracking-wider" type="number" placeholder="80 000 000 00" />
                  </div>
                </div>
                <div className="flex flex-col gap-0.5">
                  <label className=" text-sm ">Role</label>
                 <select className="w-full h-8 pl-3 pr-3  border-black border-[1px] rounded-xl ">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <div className="relative w-full ">
                    <input className="w-full h-8 pl-3  border-black border-[1px] rounded-xl" type={showPassword ? "text" : "password"} placeholder="Enter password" required />
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <div className="relative w-full flex items-center  ">
                    <input className="w-full h-8 pl-3  border-black border-[1px] rounded-xl" type={showPassword1 ? "text" : "password"} placeholder="Confirm password" required />
                ...
                <Link href="/authentication">
                  <div className="w-full h-10 text-white text-sm bg-blue-600 flex items-center justify-center rounded-xl shadow-2xl border-1 cursor-pointer mt-2">
