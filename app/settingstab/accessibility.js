      ...
      <div className='w-full h-fit border-[1px] border-[#EBEBEB] rounded-[12px] shadow-xs shadow-[#C6C6C61A] '>
        ...
        <div className='h-[75px] w-[95%] flex justify-between items-center border-b-[1px] border-[#F0F2F5] m-auto  '>
          ...
          <div className='flex items-center gap-2'>
            <div className=' border-[#3B3B3B] border-[1px] rounded-[2px] flex items-center justify-center h-[36px] w-[89px]'>
              <h1>Tab / Shift</h1>
            </div>
            +
            <div className=' border-[#3B3B3B] border-[1px] rounded-[2px] flex items-center justify-center h-[36px] w-[45px]'>
              <h1>Tab</h1>
            </div>
          </div>
        </div>
        <div className='h-[75px] w-[95%] flex justify-between items-center border-b-[1px] border-[#F0F2F5] m-auto  '>
          ...
          <div className='flex items-center gap-2'>
            <div className=' border-[#3B3B3B] border-[1px] rounded-[2px] flex items-center justify-center h-[36px] w-[56px]'>
              <h1>Enter</h1>
            </div>
          </div>
        </div>
