  ...
  return (
    <div className='h-full  w-[95%] flex flex-col m-auto '> 
      ...
      <div className='h-full  w-full m-auto flex items-center  gap-4'>
        <div className='h-[114px] bg-[#FFFFFF] w-[25%] flex rounded-[8px] border  border-[rgba(240,242,245,1)] shadow-[0px_4px_0px_0px_rgba(15,15,15,0.02)]'>
      ...
      <div className='mt-10  min-w-full  flex flex-col '>
        <div className='min-h-[15%] w-full border bg-[#FFFFFF] border-[rgba(240,242,245,1)]  rounded-t-xl flex items-center'>
      ...
      <div className='mt-10 min-w-full  flex flex-col mb-10 pb-20'>
        <div className='min-h-[15%] w-full bg-[#FFFFFF] border border-[rgba(240,242,245,1)]  rounded-t-xl flex items-center'>
